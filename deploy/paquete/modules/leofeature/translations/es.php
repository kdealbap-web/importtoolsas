...
/* Añadido por Importtools, 03/08/2026 --------------------------------------
   `leofeature.php:1354` define el aviso que sale al pulsar el corazón sin haber
   entrado con cuenta:  $this->l('You must be logged in to manage your wishlist')
   No venía traducido, así que a un visitante anónimo le aparecía en INGLÉS.
   La clave del formato heredado es md5 del texto original:
       md5('You must be logged in to manage your wishlist')
       = 019b05578911596956b81b9a90ea36e7
   Se aprovecha para que además diga qué hacer, no solo qué falta. */
$_MODULE['<{leofeature}prestashop>leofeature_019b05578911596956b81b9a90ea36e7'] = 'Entra a tu cuenta para guardar productos en tus favoritos.';
