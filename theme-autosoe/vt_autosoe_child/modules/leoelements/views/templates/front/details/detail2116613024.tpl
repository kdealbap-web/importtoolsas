...
<section id="main" class="product-detail product_image_no_thumbs_fullwidth product-image-thumbs no-thumbs"><div class="row"><div class="offset-lg-2 offset-xl-2 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 col-sp-12">
...
{/block}{block name='product_description'}
       		<div class="product-description-short-2">{$product.description|truncate:200:'...'  nofilter}</div>
     	{/block}
