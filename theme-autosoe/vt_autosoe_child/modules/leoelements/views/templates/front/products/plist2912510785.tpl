...
{hook h='displayLeoCompareButton' product=$product}
    ...
    <div class="product-meta"><div class="product__overlay"></div>{if isset($product.category_name) && isset($product.id_category_default)}
...
<span class="in-stock">{l s='In Stock' d='Shop.Theme.Actions'}</span>
{else}
