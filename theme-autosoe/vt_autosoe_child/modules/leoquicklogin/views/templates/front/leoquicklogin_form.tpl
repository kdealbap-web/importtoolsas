{* * @Module Name: Leo Quick Login * @Website: leotheme.com.com - prestashop
template provider * @author Leotheme
<leotheme@gmail.com>
  * @copyright Leotheme *}
  <div
    class="leo-quicklogin-form row{if isset($leo_form_type) && $leo_form_type != ''} {$leo_form_type|escape:'html':'UTF-8'}{/if}"
  >
    {if isset($leo_navigation_style) && $leo_navigation_style}
    <ul
      class="lql-action{if $leo_form_layout != 'both'} lql-active{else} lql-inactive{/if}"
    >
      <li class="lql-action-bt">
        <p
          class="lql-bt lql-bt-login{if $leo_form_layout == 'login'} lql-active{/if}"
        >
      ...
      <li class="lql-action-bt">
        <p
          class="lql-bt lql-bt-register{if $leo_form_layout == 'register'} lql-active{/if}"
        >
          {l s='Register' mod='leoquicklogin'}
        </p>
      </li>
    </ul>
    {/if}
    <div
      class="leo-form leo-login-form col-sm-{if $leo_form_layout == 'both'}6{else}12{/if}{if $leo_form_layout == 'login' || $leo_form_layout == 'both'} leo-form-active{else} leo-form-inactive{/if}{if $leo_form_layout != 'both'} full-width{/if}"
    >
      ...
      >
        ...
        <div class="form-group lql-form-content-element">
          <input
            ...
            required=""
            placeholder="{l s='Email Address' mod='leoquicklogin'}"
          />
        </div>
        <div class="form-group lql-form-content-element">
          <input
            ...
            autocomplete="on"
            required=""
            placeholder="{l s='Password' mod='leoquicklogin'}"
          />
        ...
        <div class="form-group row lql-form-content-element">
          <div class="col-xs-6">
            ...
            <label class="form-control-label"
              ><span>{l s='Remember Me' mod='leoquicklogin'}</span></label
            >
            {/if}
          </div>
          <div class="col-xs-6 text-sm-right">
            <a role="button" href="#" class="leoquicklogin-forgotpass"
              >{l s='Forgot Password' mod='leoquicklogin'}</a
            >
          </div>
        </div>
        <div class="form-group text-right">
          ...
          >
            ...
            <i class="leoquicklogin-icon leoquicklogin-fail-icon material-icons"
              >&#xE033;</i
            >
            <span class="lql-bt-txt"> {l s='Login' mod='leoquicklogin'} </span>
          </button>
        </div>
        <div class="form-group lql-callregister">
          <a role="button" href="#" class="lql-callregister-action"
            >{l s='No account? Create one here' mod='leoquicklogin'}</a
          >
        </div>
      </form>
    ...
    <div
      class="leo-form leo-register-form col-sm-{if $leo_form_layout == 'both'}6{else}12{/if}{if $leo_form_layout == 'register' || $leo_form_layout == 'both'} leo-form-active{else} leo-form-inactive{/if}{if $leo_form_layout != 'both'} full-width{/if}"
    >
      ...
      >
        ...
        <div class="form-group lql-form-content-element">
          <input
            ...
            placeholder="{l s='First Name' mod='leoquicklogin'}"
          />
        </div>
        <div class="form-group lql-form-content-element">
          <input
            ...
            required=""
            placeholder="{l s='Last Name' mod='leoquicklogin'}"
          />
        </div>
        <div class="form-group lql-form-content-element">
          <input
        ...
        <div class="form-group lql-form-content-element">
          ...
          <input
            ...
            required=""
            placeholder="{l s='Captcha' mod='leoquicklogin'}"
          />
        </div>
        {/if} {if $leo_check_terms }
        <div class="form-group lql-form-content-element leo-form-chk">
          <label class="form-control-label">
            ...
            />
            {if $url_gdpr}<a href="{$url_gdpr|escape:'html':'UTF-8'}"
              >{/if}{l s='I agree to the terms.' mod='leoquicklogin'}{if
              $url_gdpr}</a
            >{/if} <span style="color:red">*</span>
          </label>
        </div>
        {/if} {if $leo_newsletter }
        <div class="form-group lql-form-content-element">
          <label class="form-control-label">
            <input
              class="newsletter"
        ...
        <div class="form-group lql-calllogin">
          ...
          <a role="button" href="#" class="lql-calllogin-action"
            >{l s='Log in instead' mod='leoquicklogin'}</a
          >
          ...
          <a
            ...
            >{l s='Reset password' mod='leoquicklogin'}</a
          >
        </div>
      </form>
    </div>
